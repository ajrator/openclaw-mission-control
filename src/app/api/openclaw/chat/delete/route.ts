...
export async function POST(request: Request) {
    ...
    const explicitSessionKey = typeof sessionKeyParam === 'string' ? sessionKeyParam.trim() : '';
    const sessionKey = explicitSessionKey || (agentId ? resolveDirectChatSessionKey(agentId, sessionKeyParam) : null);
    if (!sessionKey) {
